...
export async function getDadosUsuarioAnfitriaoPorIdAnuncio(
  id: number,
  ...
  const tempoCadastro = usuario.criado_em
    ? calcularTempoCadastro(usuario.criado_em)
